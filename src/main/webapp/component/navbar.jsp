...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa-sharp fa-solid fa-hospital"></i> DOC HOME</a>
				...
				<c:if test="${empty userObj}">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="user_appointment.jsp"><i
							class="fa-solid fa-calendar-days"></i> APPOINTMENT</a></li>
					<li class="nav-item"><a class="nav-link active"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="view_appointment.jsp"><i
							class="fa-solid fa-calendar-days"></i> VIEW APPOINTMENT</a></li>
